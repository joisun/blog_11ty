...
## 一、**<span style="color:red">Array 构造函数</span>**有两个ES6 新增的**用于创建数组的**静态方法：
...
## 十、迭代方法 `every()`, `some()`, `filter()`, `forEach()`, `map()`
